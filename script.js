...
const messages = [
    ...
    "I'll let you pick the next date idea! 😉",
    "I'll be your forever personal chef! 🍕",
    "Think about all the cuddles you’ll miss... 🐻",
    "Even the Felicia would be disappointed! 🐾",
    "Imagine how cute we’d be together!",
    "I’m running out of ways to convince you 😵‍💫",
    "If you say yes, I'll love you even more (if that's possible)!",
    "We are literally meant to be!",
